...
from estimator import PetalsEstimator
from server_config_example import get_2060_example, get_4060_example, get_4070ti_example, get_4090_example
from utils import EstimateResults
...
def main():
    ...
    for seq_len, batch_size in test_settings:
        results: EstimateResults = estimator.run_and_print(seq_len, batch_size)
